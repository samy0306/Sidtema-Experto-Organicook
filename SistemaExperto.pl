...
usuario:-
    ...
    send_list(Altura, append,['menor a 1.55','1.55 - 1.76','mas de 1.76']),
    new(Edad,
        menu('3.-¿En que rango de edad se encuentra?')),
    send_list(Edad,append,['18-29 años','30-60 años','mayor a 60 años']),
    new(Objetivo,
...
image('Hipocalorico/vegetariano/keto','31.JPG').
